...
typedef void    (^SRRefreshStartBlock)(SRRefreshView* sender);
typedef void    (^SRRefreshEndBlock)(SRRefreshView* sender);
...
@property (nonatomic, copy)     SRRefreshStartBlock      startBlock;
@property (nonatomic, copy)     SRRefreshEndBlock   endBlock;
...
//stop in time
@property (nonatomic, assign)   BOOL    slimeStopInTime;
